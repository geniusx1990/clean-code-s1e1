...
var taskInput = document.querySelector('.tasks_input_text_new-task');//Add a new task.
...
var createNewTaskElement = function (taskString) {
    ...
    deleteButton.alt = 'remove button';
...
var editTask = function () {
    ...
    var label = listItem.querySelector('.tasks_label');
